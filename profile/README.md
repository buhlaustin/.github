...
**Co-Founder, CEO & Chief Architect @[![ClassQuip](https://github.com/ClassQuip)**
...
[![ClassQuip](https://img.shields.io/badge/ClassQuip-K--12%20Virtual%20Classroom-2563eb?style=for-the-badge&logo=googleclassroom&logoColor=white)](https://classquip.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Austin%20Buhl-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/austinbuhl20)
[![Email](https://img.shields.io/badge/Email-abuhl%40classquip.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:abuhl@classquip.com)

---

## What I'm building

**[ClassQuip](https://classquip.com)** equips every teacher with a smarter classroom — live video, real-time participation analytics, interactive polls, instant breakout groups, and moderated chat in one high-performance platform.

Teachers shouldn't have to juggle tabs to run a lesson. ClassQuip is purpose-built for active, distraction-free digital learning:

- **Live participation analytics** — see who's engaged, who's struggling, and who needs a nudge in real time
- **Quip polls & tools** — launch polls, word clouds, and exit tickets without leaving the room
- **Instant breakout groups** — spin up rooms with one click and bring everyone back seamlessly
- **Moderated live chat** — keep conversations safe and on-topic with teacher-controlled moderation
- **Built for K-12 safety** — FERPA-aware design with role-based controls for schools and districts
- **LMS native** — deep LTI 1.3 integration with Canvas, Blackboard, Schoology, and Clever

As Chief Architect, I design and ship the platform end to end — from real-time classroom infrastructure to the teacher workflows that have to work on a Tuesday morning with 28 seventh graders.
...
|------|-------------------|
| **Product** | Teacher-first workflows, zero-friction engagement tools, district-ready safety |
| **Architecture** | Real-time systems, scalable classroom infrastructure, LMS integrations |
| **Education** | K-12 live, hybrid, and remote instruction that keeps students participating |
| **AI** | Practical classroom intelligence — engagement signals and teacher assistance, not gimmicks |
...
- **LinkedIn:** [linkedin.com/in/austinbuhl20](https://www.linkedin.com/in/austinbuhl20)
- **Email:** [abuhl@classquip.com](mailto:abuhl@classquip.com)

---

<p align="center">
  <i>Equip every teacher with a smarter classroom.</i>
</p>
